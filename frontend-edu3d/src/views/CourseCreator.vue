        ...
        <div class="creator-header">
          <div class="creator-header-left">
            ...
            <div>
              ...
              <p class="creator-sub">Remplissez les informations et ajoutez un modèle 3D</p>
            </div>
          </div>
          ...
          <div class="form-col">
            ...
            <div class="model-section">
              <div class="model-section-header">
                ...
                <span class="model-section-hint">optionnel</span>
              </div>
              ...
              <div v-if="inputMode === 'url'" class="form-group" style="margin-bottom:0">
                <div :class="['input-wrap', { focused: focus.url }]">
                  ...
                  <input
                    ...
                    @blur="focus.url = false; tryLoadModel()"
        ...
        <div class="creator-footer">
          ...
          <div class="footer-right">
            ...
            <button
              ...
              <span v-if="!isLoading">
                {{ mode === 'create' ? '🚀 Créer le cours' : '💾 Sauvegarder' }}
              </span>
...
const demoModels = [
  { name: 'Canard',    icon: '🦆', url: 'https://threejs.org/examples/models/gltf/Duck/glTF/Duck.gltf' },
...
function tryLoadModel() {
  // Le watcher dans ThreeViewer s'occupe du reload automatique
}
...
function processFile(file) {
  ...
  // Stocker l'URL pour l'envoyer avec le formulaire si besoin
...
async function handleSubmit() {
  ...
  try {
    await emit('submit', {
      ...
      object3dUrl: activeModelUrl.value || null
    })
  } finally {
...
/* BODY */
/* BODY GRID — viewer plus grand */
.creator-body {
  display: grid;
  grid-template-columns: 420px 1fr;   /* ← formulaire fixe, viewer prend le reste */
  gap: 0;
  flex: 1;
  overflow: hidden;
...
.f-textarea {
  ...
  border-radius: 10px; padding: 0.65rem 0.9rem;
  color: #fff; font-family: 'DM Sans', sans-serif;
  font-size: 0.88rem; outline: none; resize: vertical;
...
.load-btn {
  ...
  color: #a78bfa; font-size: 0.75rem; cursor: pointer;
...
.viewer-wrap {
  ...
  border: 1px solid rgba(167,139,250,0.1);
  position: relative;
  min-height: 420px;                   /* ← hauteur minimum viewer */
  background: #060918;
}
.viewer-empty {
